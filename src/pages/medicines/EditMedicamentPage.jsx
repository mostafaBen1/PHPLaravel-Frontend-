...
export async function EditMedicamentLoader({ params }) {
  const res = await getOneMedicine(params.id);
  return res.data;
}
...
const EditMedicamentPage = () => {
  ...
  const [prescriptionRequired, setPrescriptionRequired] = useState(
    data.prescriptionRequired == 1 ? true : false
  );
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="flex w-1/2 flex-col gap-6 mb-4">
          <Select
            ...
            onChange={(value) => setPrescriptionRequired(value == 'true' ? true : false)}
