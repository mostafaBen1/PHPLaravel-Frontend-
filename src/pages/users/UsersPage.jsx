...
import { changeUsersByGlobalCheck, changeUsersIds, deleteUsers, fetchUsers } from "../../services/redux/GetUsersSlice";
...
const UsersPage = () => {
  ...
  const checkGlobalBox = (_) => {
    ...
    dispatch(changeUsersByGlobalCheck(!globalCheck));
  };
